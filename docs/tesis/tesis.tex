...
y se establece que el techo de mejora por agrupacion es del 10,9\,\%. Sobre ese
techo se construye un estimador y se mide cuanto de el se recupera.
...
La distribucion de ese catalogo es el problema entero:
...
De ahi sale el presupuesto del trabajo. Comparando la desviacion del error real
contra el suelo irreducible:
...
El rango jerarquico da una escalera monotona de cinco escalones con un recorrido
de \textbf{$2{,}11\times$ en salario} entre el nivel 1 y el nivel 5. Se obtiene de
