# Handoff — Benchmarking Salarial

Documento de contexto para retomar el proyecto. Contiene el qué, el porqué de las decisiones ya tomadas, y qué construir. **Léelo completo antes de escribir código.**
